		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
                  ...
                  <option value="" selected="selected" class="form-control">***Chọn một***</option>
                  ...
                  <option value="manage-pages.php?type=aboutus">Giới thiệu</option> 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Trang được chọn</label>
												<div class="col-sm-8">
						<?php
...
?>
											...
											<div class="form-group">
												...
												<button type="submit" name="submit" value="Cập nhật" id="submit" class="btn-primary btn">Update</button>
												</div>
											</div>
