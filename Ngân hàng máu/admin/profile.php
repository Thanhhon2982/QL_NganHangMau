...
if (isset($_POST['submit'])) {
    ...
    $mobno = htmlspecialchars($_POST['mobilenumber']);
	...
	if (empty($_FILES["fileInput"]["name"])) {
		...
		$query->execute();
		echo '<script>alert("Bạn đã cập nhật thông tin cá nhân thành công")</script>';
		echo "<script>window.location.href ='profile.php'</script>";
	} else {
		$sql = "UPDATE tbladmin SET AdminName=:adminname, MobileNumber=:mobilenumber, Email=:email, Avatar=:avatar WHERE UserName=:aid";
		$query = $dbh->prepare($sql);
		$query->bindParam(':adminname', $AName, PDO::PARAM_STR);
		$query->bindParam(':email', $email, PDO::PARAM_STR);
		$query->bindParam(':mobilenumber', $mobno, PDO::PARAM_STR);
		$query->bindParam(':avatar', $fileName, PDO::PARAM_STR);
		$query->bindParam(':aid', $adminid, PDO::PARAM_STR);
		$query->execute();
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Thông tin Admin</h2>
							...
							<div class="col-md-10">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" enctype="multipart/form-data" class="form-horizontal" onSubmit="return valid();" >
...
{               ?>
											...
											<div class="form-group" style="margin: 0 39.6%;">
												 <img style="border-style: solid;border-radius: 50%;" height="200px" width="200px" src="img/<?php echo $row->Avatar?>" class="ts-avatar hidden-side">
												 <input style=" margin:20px 40px;" type="file" name="fileInput" id="fileInput" ></input>
											</div>
											<div class="hr-dashed"></div>
											<div class="form-group">
												<label class="col-sm-4 control-label">Tên quản trị viên</label>
												<div class="col-sm-8">
								...
								<div class="hr-dashed"></div>
											<div class="form-group">
												<label class="col-sm-4 control-label">Tài khoản tạo ngày</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit">Lưu cập nhật</button>
												</div>
											</div>
