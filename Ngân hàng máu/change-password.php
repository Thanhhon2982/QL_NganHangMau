...
echo '<script>alert("Bạn đổi mật khẩu thất bại. Vui lòng thử lại!")</script>';
		...
		<div class="py-xl-5 py-lg-3">
			...
			<div class="d-flex">
				...
				<div class="contact-right-w3l appoint-form">
					<h5 class="title-w3 text-center mb-5">Đặt lại mật khẩu</h5>
					<form action="#" method="post" onsubmit="return checkpass();" name="changepassword">
						...
						<div class="form-group">
							<label for="recipient-phone" class="col-form-label">Xác nhận mật khẩu</label>
							<input type="password" class="form-control" name="confirmpassword" id="confirmpassword"  required='true'>
						</div>
						
						<input type="submit" value="Cập nhật" name="change" class="btn_apt">
					</form>
				</div>
