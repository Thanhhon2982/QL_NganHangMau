...
{
	$user_id =$_POST['email'];
	$insert_query = "INSERT INTO login_history (user_id, login_date) VALUES (:user_id, CURRENT_DATE)";
	$query_lg = $dbh->prepare($insert_query);
	$query_lg->bindParam(':user_id', $user_id, PDO::PARAM_STR);
	$query_lg->execute();
...
<div class="login px-4 mx-auto mw-100">
                            ...
                            <form  method="post" name="login">
                                ...
                                <button type="submit" class="btn submit mb-4" name="login">Đăng nhập</button>
                                <p class=" text-center pb-4">
                                    <a href="forgot-password.php" class="forgot">Quên mật khẩu?</a>
                                </p>
