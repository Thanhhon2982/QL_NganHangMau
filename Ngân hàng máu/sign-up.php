...
echo "<script>alert('Chúc mừng bạn đã đăng kí thành công');</script>";
}
else
{
...
echo "<script>alert('Email này đã đăng kí. Vui lòng nhập Email khác!');</script>";
}
}
...
<body>
 ...
 <div class="login px-4 mx-auto mw-100">
                            <h5 class="text-center mb-4">Đăng kí nhanh</h5>
...
<?php }} ?>
                                ...
                                <button type="submit" class="btn btn-primary submit mb-4" name="submit">Đăng kí</button>
